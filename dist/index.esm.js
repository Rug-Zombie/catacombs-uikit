...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React.createElement(Icon$1g, { color: "white" })));
};
...
var Icon$b = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 195.2 124.98", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("rect", { x: "88.5", y: "78.5", width: "17.34", height: "28.89" }),
        React.createElement("rect", { x: "0.5", y: "110.5", width: "194.2", height: "13.98" }),
        React.createElement("path", { d: "M111.05,5.43l67,39a21.44,21.44,0,0,1,11,19v46h-17v-41c0-5-3-9-7-12l-58-33c-4-3-9-3-14,0l-58,33c-4,3-7,7-7,12v41h-17v-46a21.44,21.44,0,0,1,11-19l23-14v-14h0c-1,0-2,0-2-1v-2a3.49,3.49,0,0,1,2-1h13l1,1v2a1,1,0,0,1-1,1h-1v7l32-18A21.67,21.67,0,0,1,111.05,5.43Z", transform: "translate(-2.55 -1.93)" }),
        React.createElement("rect", { x: "85.5", y: "31.5", width: "10.67", height: "12.14" }),
        React.createElement("rect", { x: "85.5", y: "45.5", width: "10.67", height: "12.14" }),
        React.createElement("rect", { x: "99.5", y: "31.5", width: "10.67", height: "12.14" }),
        React.createElement("rect", { x: "99.5", y: "45.5", width: "10.67", height: "12.14" })));
};

var Icon$a = function (props) {
    return (React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 80.75 47.25" }, props),
        React.createElement("path", { d: "M57.3,57.7a8.8,8.8,0,0,0,0-10.4L60,44.6a1.48,1.48,0,1,0-2.1-2.1l-2.7,2.7A9.48,9.48,0,0,0,50,43.5a8.75,8.75,0,0,0-5.2,1.7l-2.7-2.7A1.48,1.48,0,1,0,40,44.6l2.7,2.7A9.48,9.48,0,0,0,41,52.5a8.75,8.75,0,0,0,1.7,5.2L40,60.4a1.45,1.45,0,0,0,0,2.1,1.71,1.71,0,0,0,2.2,0l2.7-2.7c.2.2.5.3.7.5v1.2A1.54,1.54,0,0,0,47.1,63a1.45,1.45,0,0,0,.7-.2,1.56,1.56,0,0,0,1.3.7,1.28,1.28,0,0,0,1-.4,1.78,1.78,0,0,0,1,.4,1.71,1.71,0,0,0,1.3-.7,1.85,1.85,0,0,0,.7.2h.2a1.54,1.54,0,0,0,1.5-1.5V60.1c.1-.1.3-.2.4-.3l2.7,2.7a1.71,1.71,0,0,0,2.2,0,1.45,1.45,0,0,0,0-2.1ZM50,60.9a1.78,1.78,0,0,0-1-.4.9.9,0,0,0-.5.1V59.4a1.43,1.43,0,0,0-.6-1.2c-.1-.1-.2-.1-.3-.2a6,6,0,1,1,5-.1,1.42,1.42,0,0,0-.8.9.9.9,0,0,0-.1.5v1.3a.1.1,0,0,1-.1.1,1.85,1.85,0,0,0-.7-.2A1.22,1.22,0,0,0,50,60.9Z", transform: "translate(-9.63 -31.33)" }),
        React.createElement("path", { d: "M51.5,55.7a1.69,1.69,0,0,0,1,.3,2,2,0,1,0-2-2v.4a1.09,1.09,0,0,0-.5-.1c-.1,0-.4,0-.5.1V54a2,2,0,1,0-2,2,1.69,1.69,0,0,0,1-.3v1.6a1.5,1.5,0,0,0,3,0V55.7Z", transform: "translate(-9.63 -31.33)" }),
        React.createElement("path", { d: "M88.5,78.2h-77A1.54,1.54,0,0,1,10,76.7V33.2a1.54,1.54,0,0,1,1.5-1.5h77A1.54,1.54,0,0,1,90,33.2V76.7A1.47,1.47,0,0,1,88.5,78.2ZM13,75.2H87V34.8H13Z", transform: "translate(-9.63 -31.33)" }),
        React.createElement("path", { d: "M29.5,55a20.09,20.09,0,0,1,6.8-15.2H19.5A1.54,1.54,0,0,0,18,41.3V68.8a1.54,1.54,0,0,0,1.5,1.5H36.3A20.47,20.47,0,0,1,29.5,55Z", transform: "translate(-9.63 -31.33)" }),
        React.createElement("path", { d: "M80.5,39.8H63.7a20.39,20.39,0,0,1,0,30.4H80.5A1.54,1.54,0,0,0,82,68.7V41.2A1.45,1.45,0,0,0,80.5,39.8Z", transform: "translate(-9.63 -31.33)" })));
};

var Icon$9 = function (props) {
    return (React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 25.52 36.38" }, props),
        React.createElement("path", { d: "M30.21,29.57,23.27,17.09l.05-5.75h.95a1,1,0,0,0,0-2h-12a1,1,0,0,0,0,2h1l0,5.75L6.33,29.57a4.57,4.57,0,0,0,4,6.77h15.9a4.56,4.56,0,0,0,4.56-4.56A4.49,4.49,0,0,0,30.21,29.57ZM15.14,17.83a1,1,0,0,0,.13-.5l0-6h6.1l-.05,6a1.06,1.06,0,0,0,.13.5L25,24.26a22.6,22.6,0,0,1-5.94-1,25.89,25.89,0,0,0-6.37-1Z", transform: "translate(-5.51 -0.22)" }),
        React.createElement("circle", { cx: "9.76", cy: "4.13", r: "2" }),
        React.createElement("circle", { cx: "16.26", cy: "5.63", r: "1.5" }),
        React.createElement("circle", { cx: "14.76", cy: "1.13", r: "1" })));
};

var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 38.5 48.4" }, props),
        React.createElement("path", { className: "cls-1", d: "M34.4,45.1H27V42.4a13.4,13.4,0,0,1-2,.1,13.4,13.4,0,0,1-2-.1v2.7H15.6a1.9,1.9,0,0,0,0,3.8H34.4a1.9,1.9,0,0,0,0-3.8Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("circle", { className: "cls-1", cx: "19.25", cy: "21.25", r: "2.5" }),
        React.createElement("path", { className: "cls-1", d: "M12.4,14l9.5,5.6a2.34,2.34,0,0,1,.7-.7L17,9.4A14.43,14.43,0,0,0,12.4,14Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M17,34.7l5.6-9.5a2.34,2.34,0,0,1-.7-.7L12.4,30A13.78,13.78,0,0,0,17,34.7Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M28.3,36.6,25.5,26h-1L21.7,36.7a18.59,18.59,0,0,0,3.3.4A18.81,18.81,0,0,0,28.3,36.6Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M10,22a12.42,12.42,0,0,0,.4,3.3L21,22.5a1.7,1.7,0,0,1,0-1L10.3,18.7C10.2,19.8,10,20.9,10,22Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M27,9.5a2.08,2.08,0,0,1-4,0l-.7-2.2c-.2,0-.4.1-.6.1l2.8,10.7h1L28.3,7.4c-.2,0-.4-.1-.6-.1Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M37.6,30l-9.5-5.6a2.34,2.34,0,0,1-.7.7L33,34.6A12.68,12.68,0,0,0,37.6,30Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M28.8,3.4l-.6,1.9a17,17,0,1,1-6.5,0l-.6-1.9a19.05,19.05,0,1,0,7.7,0Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M33,9.4l-5.6,9.5a2.34,2.34,0,0,1,.7.7L37.6,14A14.43,14.43,0,0,0,33,9.4Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M40,22a12.42,12.42,0,0,0-.4-3.3L29,21.5v1l10.7,2.8A31.06,31.06,0,0,0,40,22Z", transform: "translate(-5.75 -0.75)" }),
        React.createElement("path", { className: "cls-1", d: "M24.4,9.1a.56.56,0,0,0,1.1,0l2.2-7.3a.55.55,0,0,0-.5-.8H22.8a.64.64,0,0,0-.6.8Z", transform: "translate(-5.75 -0.75)" })));
};
